...
1. Deploy an instance of SAP Adaptive Server Enterprise on IBM Cloud from the IBM Cloud Catalog. See [Provisioning](?topic=sap-ase-managed-provisioning) for a detailed guide.
